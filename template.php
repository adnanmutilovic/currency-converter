      ...
      <div class="modal-body w-full">
        ...
        <form  id="updateCurrencyForm">
          ...
          <div class="form-group">
            ...
            <input type="text" id="name" placeholder="e.g. EUR to USD" class="form-control form-control-sm">
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body w-full">
        ...
        <form  id="submitForm">
          ...
          <div class="form-group">
            <label for="name">Template Name:</label>
            <input type="text" id="name" name="name" placeholder="e.g. EUR to USD" class="form-control form-control-sm">
          </div>
...
<button type="submit" data-bs-toggle="modal"  data-bs-target="#insertTemplateCurrencyModal" class="btn btn-primary mt-2">Add Template</button>
